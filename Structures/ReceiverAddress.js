/**
 * Struktura adresowa danych odbiorcy - od podstawowej struktury adresowej różni się tym, że zawiera dodatkowe pola umożliwiające definiowane adresów zagranicznych. Opisywana struktura jest podstawowym obiektem służącym do przekazywania danych adresowych. Jest wykorzystywana na przykład przy przekazywaniu adresów nadania oraz doręczenia w metodzie createShipments.
 * @constructor
 ...
 */
function ReceiverAddress(country, isPackstation, isPostfiliale, postnummer, name, postalCode, city, street, houseNumber, apartmentNumber, contactPerson, contactPhone, contactEmail) {
