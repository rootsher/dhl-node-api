 ...
 * @param {AuthData} authData Struktura autoryzacyjna.
 * @param {ShipmentFullData[]} shipments Tablica z minimum jedną strukturą definiującą przesyłkę (maksymalnie trzema).
 */
 ...
 * @param {string[]} shipmentIdList Tablica elementów typu string, zawierająca identyfikatory przesyłek.
 ...
 * @param {AuthData} authData Struktura autoryzacyjna.
 * @param {string[]} shipments Tablica tekstowych identyfikatorów przesyłek.
 */
 ...
 * @param {AuthData} authData Struktura autoryzacyjna.
 * @param {string} orderId Numer zlecenia zamówienia kuriera, uzyskany za pomocą metody bookCourier.
 */
DHLNodeAPI.prototype.cancelCourierBooking = function cancelCourierBooking(orderId) {
 ...
 * @param {AuthData} authData Struktura autoryzacyjna.
 * @param {ItemToPrint[]} itemsToPrint Tablica struktur typu ItemToPrint (maksymalnie trzy struktury).
 */
 ...
 */
DHLNodeAPI.prototype.getPnp = function getPnp(date, type) {
 ...
 * @param {AuthData} authData Struktura autoryzacyjna.
 * @param {string} postalCode Kod pocztowy w formacie 5 cyfr (bez kreski).
 * @param {string} pickupDate Data, dla której sprawdzamy dostępność usług (w formacie RRRR-MM-DD).
 */
DHLNodeAPI.prototype.getPostalCodeServices = function getPostalCodeServices(postalCode, pickupDate) {
 ...
 * @param {AuthData} authData Struktura autoryzacyjna.
 * @param {string} shipmentIdentificationNumber Numer przesyłki, która ma zostać usunięta.
 * @param {string} dispatchIdentificationNumber Identyfikator zamówienia kuriera do anulowania.
 */
DHLNodeAPI.prototype.deleteShipment = function deleteShipment(shipmentIdentificationNumber, dispatchIdentificationNumber) {
	return this._client.deleteShipment({
		authData: this._authData,
		shipmentIdentificationNumber: shipmentIdentificationNumber,
		dispatchIdentificationNumber: dispatchIdentificationNumber
	});
}
